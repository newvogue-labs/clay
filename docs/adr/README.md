...
| 041 | Forecast-модель: уточнение области решения (аддендум к ADR-011) | Proposed | docs/adr | [`041-forecast-model-scope-addendum.md`](041-forecast-model-scope-addendum.md) |
