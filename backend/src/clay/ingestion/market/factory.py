...
def build_market_client(cfg: ExchangeConfig, timeout: float = 10.0) -> MarketDataClient:
    ...
    if cfg.exchange_id == "binance_spot":
        from clay.ingestion.market.binance_client import (
            BinanceSpotClient,  # noqa: PLC0415 — lazy import avoids circular deps
        )
    ...
    if cfg.exchange_id == "bybit_spot":
        from clay.ingestion.market.bybit_client import (
            BybitClient,  # noqa: PLC0415 — lazy import avoids circular deps
        )
