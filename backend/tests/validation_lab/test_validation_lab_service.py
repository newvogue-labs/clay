...
def test_validation_lab_applies_review_when_not_blocked(
    ...
    snapshot = service.apply_activation(db_session, review.review_id)

    assert snapshot.activation_reviews[0].status == "applied"
