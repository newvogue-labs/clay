        ...
        [
            {
                ...
                "headline": "Session setup is ready",
                "summary": "Context supports a disciplined session start.",
                "published_at": now - timedelta(minutes=20),
                "symbol": "BTCUSDT",
                "source_url": "https://example.invalid/news/session-ready",
            },
            {
                "source_name": "demo_news_feed",
                "headline": "SOL rotation strengthens",
                "summary": "SOL becomes a valid replacement candidate.",
                "published_at": now - timedelta(minutes=8),
                "symbol": "SOLUSDT",
                "source_url": "https://example.invalid/news/sol-rotation",
            },
        ]
    )
...
def test_session_route_flow_handles_lifecycle_and_pair_replacement(db_session) -> None:
